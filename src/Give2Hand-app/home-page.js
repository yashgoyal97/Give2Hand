...
class HomePage extends PolymerElement {
            ...
            <main>
                <div id='schemes'>
                    <template is="dom-repeat" items="{{schemes}}">
                        <paper-card on-click="_handleViewSchemeDetails"></paper-card>
                    </template>
    ...
    _handleResponse(event){
        ...
        this.$.schemeName.value=this.schemes.schemeName;
        this.$.schemeDescription.value=this.schemes.schemeDescription;
        this.$.schemeAmount.value=this.schemes.amount;
        this.$.taxBenefit.value=this.schemes.taxBenefit;
        this.$.schemeDetails.style.display='block';
    }
